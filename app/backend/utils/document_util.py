...
def get_path_document(document_name : str):
    #Obtenemos la ruta completa de la metadata de mi documento pdf
...
def get_chunks(content_document: str, document: Metadata_Document ):
        ...
        chunk_size = document.get("chunks"), #tamaño del chunk que se lo especifico con el atributo chunks
