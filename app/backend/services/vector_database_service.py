...
###################################################
#Inicializacion de mi coleccion de mi base de datos vectorial
...
def document_in_db(document_name: str):
    ...
    #Consulto si el documento recibido por parametro ya existe en mi base de datos o no, porque
    #no quiero que se vuelva a cargar si ya esta cargado
...
def consulta_db(document_name: str):
    ...
    #Consulto si el documento recibido por parametro ya existe en mi base de datos o no
